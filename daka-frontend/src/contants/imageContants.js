...
export const LandingPageDefaultImage = {
    ...
    JOBBER_GROUP : Jobber_Group,
    HOME_JOBBER_APP : Home_Jobber_App,
    PROVIDE_AN_EASY :Provide_an_easy,
    SERVICE : [
        { img : service_one , height : '75px' , width :  '90px'},
        { img : service_two , height : '20px' , width :  '150px'},
        { img : service_three , height : '54px' , width :  '75px'},
        { img : service_four , height : '76px' , width :  '75px'},
